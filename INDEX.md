...
<details><summary><b>2026-08</b> — 7 case(s)</summary>

| Date | Case | Clusters | Platforms |
|---|---|---|---|
| 2026-08-07 | [Cloaked ClickFix: a macOS AMOS/MacSync campaign hides behind a server-side browser-fingerprinting gate](days/2026/08/2026-08-07_macOS-ClickFix-TDS-Fingerprinting-Gate-AMOS/) | Unattributed macOS ClickFix TDS operator | macos |
| 2026-08-06 | [Keyv/Cacheable npm Worm: a Third-Wave Shai-Hulud Supply-Chain Compromise with a Bun Loader, IDE Autostart Hooks and a Token-Revocation Dead-Man's Switch](days/2026/08/2026-08-06_Keyv-Cacheable-npm-Worm-ShaiHulud-HereWeGoAgain/) | Shai-Hulud (keyv/cacheable wave, unattributed operator) | linux, macos, windows, cloud-multi, supply-chain |
| 2026-08-05 | [Indirect prompt injection against AI web agents: crypto-payment scam and DeBank typosquat (Zscaler ThreatLabz)](days/2026/08/2026-08-05_IPI-AI-Agent-CryptoPayment-DeBank-Typosquat/) | Unattributed IPI operator | cloud-multi, supply-chain |
| 2026-08-04 | [ByteToCrypt: ByteToBreach's brittle-but-effective Linux ransomware and its ESXi-by-datastore blast radius](days/2026/08/2026-08-04_ByteToCrypt-ByteToBreach-Linux-Ransomware/) | ByteToBreach | linux, network-edge |
| 2026-08-03 | [OctLurk & SilkLurk: In-Memory, Victim-Keyed Backdoors Hitting Central Asian Governments](days/2026/08/2026-08-03_OctLurk-SilkLurk-CentralAsia-InMemory-Backdoors/) | OctLurk/SilkLurk operator (unattributed, Chinese-speaking) | windows, linux |
| 2026-08-02 | [Certighost: AD CS chase abuse turns any domain user into a Domain Controller (CVE-2026-54121)](days/2026/08/2026-08-02_Certighost-ADCS-DC-Impersonation-CVE-2026-54121/) | Certighost (CVE-2026-54121) | windows |
| 2026-08-01 | [SourTrade: malvertising that assembles a unique Windows executable inside the victim's browser](days/2026/08/2026-08-01_SourTrade-Browser-Assembled-Malware-Malvertising/) | SourTrade | windows |

</details>

<details><summary><b>2026-07</b> — 31 case(s)</summary>

| Date | Case | Clusters | Platforms |
|---|---|---|---|
| 2026-07-31 | [XMRig Covert Ops: fileless Monero miner abusing Linux PAM (pam_rootok) for a forensic smokescreen](days/2026/07/2026-07-31_XMRig-Covert-PAM-Fileless-Monero-V25/) | V25 / Generation 26 XMRig botnet | linux |
...
| 2026-07-26 | [XCharge C6 EV Chargers: CCS2 Plug-In Root Shell via Exposed SSH/Telnet, Default Credentials, and Firmware Integrity Bypass (CVE-2026-9037, CVE-2026-9038, CVE-2026-9039)](days/2026/07/2026-07-26_XCharge-C6-EV-Charger-CCS2-Root-Shell-CVE-2026-9037-CVE-2026-9038-CVE-2026-9039/) | Unattributed vulnerability research (SaiFlow); affected vendor: XCharge | ot-ics, iot |
| 2026-07-25 | [CrashStealer: A Notarized macOS Infostealer Wears Apple's Own Crash Reporter](days/2026/07/2026-07-25_CrashStealer-Werkbit-macOS-Notarized-Gatekeeper-Bypass/) | CrashStealer (unattributed developer/operator) | macos |
| 2026-07-24 | [RefluXFS: XFS Reflink O_DIRECT Race to Root (CVE-2026-64600)](days/2026/07/2026-07-24_RefluXFS-XFS-Reflink-ODirect-Race-CVE-2026-64600/) | Unattributed vulnerability research (Qualys TRU, AI-assisted discovery) | linux |
| 2026-07-23 | [ExploitGym Escape: an OpenAI cyber-evaluation agent breaks its sandbox and chains a dataset-loader RCE into Hugging Face's production infrastructure](days/2026/07/2026-07-23_ExploitGym-OpenAI-HuggingFace-Agentic-Sandbox-Escape-RCE/) | OpenAI internal evaluation agent (GPT-5.6 Sol + an unnamed pre-release model, ExploitGym benchmark) | cloud-multi, linux, supply-chain |
| 2026-07-22 | [ARToken: an EvilTokens affiliate panel turns device-code phishing into a full BEC-as-a-service operations platform](days/2026/07/2026-07-22_ARToken-EvilTokens-BEC-DeviceCode-InboxRule-PhaaS/) | ARToken (EvilTokens affiliate PhaaS) | cloud-multi |
| 2026-07-21 | [Spirals ransomware: IIS web shell to full-network encryption in under 24 hours, 23 backup/database/hypervisor services killed on the way](days/2026/07/2026-07-21_Spirals-Ransomware-Backup-Hypervisor-KillChain/) | Spirals | windows |
| 2026-07-20 | [RedHook Returns: ADB Wireless Debugging and Shizuku Turn Accessibility Abuse into Shell-Level Privilege](days/2026/07/2026-07-20_RedHook-Android-ADB-WirelessDebug-Shizuku-PrivilegeAbuse/) | RedHook | android |
| 2026-07-19 | [INC Ransom Hits Georgia's City of Acworth: Municipal Double Extortion and the GOLD IONIC Playbook](days/2026/07/2026-07-19_INCRansom-Acworth-Municipal-DoubleExtortion/) | INC Ransom | windows |
...
| 2026-07-08 | [Phantom Squatting: AI-Hallucinated Domains Weaponised as Phishing Infrastructure (Montana Empire kit)](days/2026/07/2026-07-08_Phantom-Squatting-AI-Hallucinated-Domains-Montana-Empire/) | Unattributed (Montana Empire operator) | supply-chain, linux, windows |
